...
async def main():
    ...
    sorrateiro = S.guild_item("sorrateiro")
    check("sorrateiro existe como técnica automática", sorrateiro and sorrateiro["categoria"] == "tecnica" and sorrateiro.get("automatica"))
    ...
    try:
        ...
        await r.handle_guild_buy("p1", "sorrateiro")
        check("comprou sorrateiro sem gastar ouro", "sorrateiro" in w["guild_owned"]["tecnicas"] and w["gold"] == 80)
    ...
    try:
        ...
        w["guild_owned"]["tecnicas"].append("sorrateiro")
        await r.handle_guild_equip("p1", "tecnica", "sorrateiro")
        check("sorrateiro ocupa o slot de técnica", w["guild_equip"]["tecnica"] == "sorrateiro")
