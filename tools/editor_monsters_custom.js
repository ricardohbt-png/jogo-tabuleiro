window.EDITOR_CUSTOM_MONSTERS = [
    ...
    "weaknesses": [
      {
        ...
        "source_ability": "vulnerabilidade",
  ...
  },
  {
    ...
    "weaknesses": [
      ...
      },
      {
        ...
        "vulnerabilidade": true,
        "source_ability": "vulnerabilidade",
        "descricao": "Vulnerabilidade: -2 nos testes de resistência escolhidos."
      }
    ],
    "equipment_enabled": true,
    "equipped_items": [
  ...
  },
  {
    ...
    "special_abilities": [
      {
        ...
        "damage": "4d6+6",
        "attack_bonus": 4,
        "descricao": "Após mover pelo menos 3 casas, faz um único ataque de chifres causando 4d6+6. Não pode realizar outros ataques no turno."
      },
      {
      ...
      },
      {
        ...
        "icon": "🪓",
        "action_type": "acao",
        "monster_effect": "brutalidade_todos_ataques",
        "damage_bonus": 2,
        "uses_per_day": null,
        "cooldown_turns": 3,
        "descricao": "Todos os ataques realizados neste turno recebem +2 de dano."
      },
      {
    ...
    "image": "minotauro",
    "portrait": "minotauro",
    "model3d": "assets/models3d/monstros/minotauro.glb",
    "size": [
      1,
      1
    ],
  ...
  },
  {
    ...
    "portrait": "minotauro",
    "model3d": "assets/models3d/monstros/minotauro.glb",
    "armor_description": "Armadura completa — descrição mecânica; não é equipamento nem gera saque.",
    "size": [
      1,
      1
    ],
  ...
  },
  {
    ...
    "special_abilities": [
      ...
      },
      {
        ...
        "icon": "🪽",
        "action_type": "passiva",
        "descricao": "Começa na altura 2. Pode alterar a altura gastando 1 ponto de movimento por ponto; perder o controle provoca queda."
      },
      {
        "id": "agarrar_aereo",
        "source": "monstro",
      ...
      },
      {
        ...
        "movement_multiplier": 2,
        "damage_bonus": 2,
        "descricao": "Recarga 5 rodadas. Dobra o deslocamento da rodada e concede +2 de dano ao próximo ataque."
      },
      {
        "id": "furia_berserker",
        "source": "monstro",
        ...
        "cooldown_turns": 5,
        "extra_attacks": 1,
        "descricao": "Recarga 5 rodadas. Repete uma vez os dois ataques de garras neste turno."
      }
    ],
    "monster_abilities": [
      {
    ...
    "image": "harpia",
    "portrait": "harpia",
    "model3d": "assets/models3d/monstros/harpia.glb",
    "size": [
      1,
      1
    ],
  ...
  },
  {
    ...
    "boss": false,
    "vscale": null,
    "so_habilidade": "golpe_devastador"
  },
  {
    "type": "boneco_furia",
    "name": "Alvo de Fúria",
