...
window.LANG_STRINGS = {
  ...
  "ui.menu.joystick_map": { "pt": "Mapa de controles e atalhos", "en": "Controls and shortcuts map" },
  "ui.menu.joystick_map_main": { "pt": "Controles principais", "en": "Main controls" },
  "ui.menu.joystick_map_move": { "pt": "Movimento e câmera", "en": "Movement and camera" },
  "ui.menu.joystick_map_shortcuts": { "pt": "Atalhos", "en": "Shortcuts" },
  "ui.menu.joystick_map_slot": { "pt": "Atalho {n}", "en": "Shortcut {n}" },
  "ui.menu.joystick_map_pause": { "pt": "Abrir pausa", "en": "Open pause" },
  "ui.menu.joystick_map_choose_tile": { "pt": "Escolher casa (A confirma)", "en": "Choose tile (Confirm activates)" },
  "ui.menu.joystick_map_right_stick": { "pt": "Cursor de alvo / câmera 3D", "en": "Target cursor / 3D camera" },
  "ui.menu.joystick_map_zoom": { "pt": "Aproximar câmera", "en": "Zoom camera in" },
  "ui.menu.joystick_map_altitude": { "pt": "Alterar altura de voo", "en": "Change flight altitude" },
  "ui.menu.joystick_map_direct_move": { "pt": "Movimento direto opcional nas configurações", "en": "Optional direct movement in settings" },
